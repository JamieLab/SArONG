# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 13:34:44 2020
...
def getBoundingPolygon(FOVh, FOVv, altitude, roll, pitch, heading, longitude, latitude):
        ...
        rotatedVectors = rotateRays(
                ray11, ray22, ray33, ray44, roll, pitch, heading)
        
        origin = Vector(longitude, latitude, altitude)
...
def getRayGroundIntersections(rays, origin):
    ...
    for i in range(len(rays)):
        intersections.append(findRayGroundIntersection(rays[i], origin) )
    return intersections
